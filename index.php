    ...
    <main data-router-wrapper="data-router-wrapper">
      <div class="page is-home -kelp" data-router-view="page" data-smooth="data-smooth">
        ...
        <section class="hero -full" data-smooth-item="data-smooth-item" style="background: #E8E5E0;">
          <div class="hero-content s sp-hero-content" style="background: #E8E5E0;">
            <div class="hero-title sp-hero-title">
              ...
              <p class="p1">Concierge, discretion-focused care for individuals looking to take the first step to recovery in the comfort of their home</p>
              <a href="contact.php" class="p1 btn-submit btn-green">Speak With Our Team</a>
            </div>
          </div>
          <div class="hero-asset sp-hero-asset">
        ...
        <section class="splitblock" data-smooth-item="data-smooth-item">
          <div class="splitblock-content">
            <div class="splitblock-repater">
              <div class="splitblock-item" style="border-top: none;">
