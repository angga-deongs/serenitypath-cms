    ...
    <body>
        ...
        <main data-router-wrapper="data-router-wrapper">
            <div class="page page-service is-institute -kelp" data-router-view="page" data-smooth="data-smooth">
                ...
                <section class="hero -fixed" data-smooth-item="data-smooth-item">
                    <div class="hero-content s">
                        <div class="hero-header">
                            <!-- <div class="hero-tag"><p class="p2">Personalized, proactive, preventive care</p></div> -->
                        </div>
                        <h1 class="t2 hero-title -default" style="width: 100%;"><span class="title-line" data-split="lines,words,chars">Supplementary<br />Care</span></h1>
                    </div>
                ...
                <section class="info service-description" data-smooth-item="data-smooth-item">
                    <div class="info-content">
                        <div class="info-block s">
                            <div class="info-description" style="border: none;">
                                <p class="p5">
                                    Immersed within the very core of Serenity Path's values, this profound philosophy empowers the essence of every cherished client, igniting a transformative journey that nurtures our shared vision of restoration and renewal.
                                </p>
                                <p class="info-description-sub">These services are at your disposal not only throughout the detox phase but also during the subsequent transitional period, should you decide to take advantage of them</p>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="physical_health" class="contact single_circle" data-smooth-item="data-smooth-item">
                    <div class="contact-content s">
                        <div class="contact-title" style="justify-content: center; display: flex; flex-direction: column;">

                            <div class="circle-info">
                                <h3 class="t5 split-title">Physical Health</h3>
                                <!-- <p class="circle-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p> -->
                            </div>
                            
                            <div class="col col-7 col-sm-7 col-md-7 col-lg-8 col-xl-6 single_circle__wrapper">

                                <img src="images/gradient.png" alt="" class="grad-cover">

                                <video src="video/vid2.mp4" class="cover loaded single_circle__video" autoplay playsinline loop="" muted="" style="position: absolute; width: 800px; height: auto;">
                                    <!-- <source src="video/vid2.mp4" type='video/mp4; codecs="hvc1"' > -->
                                </video>

                                <!-- <iframe 
                                  src="https://youtube.com/shorts/PoQ7Pf2oISU?autoplay=1&rel=0&modestbranding=1&showinfo=0&controls=0" 
                                  frameborder="0" 
                                  allowfullscreen
                              ...
                              >
                                ...
                                <div class="single_circle__inner">
                                    <div class="single_circle__txt single_circle__txt--number-1">
                                        Intermittent Hypoxic<br />
                                        Hyperpoxic Treatment
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-2">
                                        IV Drips
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-3">
                                        Massage
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-4">Reflexology</div>
                                    <div class="single_circle__txt single_circle__txt--number-5">Acupuncture</div>
                                    <div class="single_circle__txt single_circle__txt--number-6">Personal Chef &<br />Nutritionist Plan</div>
                                    <div class="single_circle__txt single_circle__txt--number-7">
                                        Juice Cleanse
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-8">
                                        Herbal<br />
                                        approaches
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-9">
                                        Biochemical<br />
                                        Restoration
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-10">
                                        Personal<br />
                                        training
                                    </div>

                                    <!-- <div class="single_circle__txt single_circle__txt--number-11">
                                        Lifestyle &amp;<br />
                                        Nutritional Counseling
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-12">
                                        Biofeedback<br />
                                        &amp; Bioresonance
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-13">Yoga</div>
                                    <div class="single_circle__txt single_circle__txt--number-14">
                                        Reflexology<br />
                                        &amp; Acupuncture
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-15">Massages</div>
                                    <div class="single_circle__txt single_circle__txt--number-16">Personal Training</div> -->

                                    <style>
                                        .circle-text{ font-size: 16px; font-weight: 400; }
                                    </style>
                                    ...
                                    >
                                        <circle cx="350" cy="350" r="300" fill="none" class="dash"></circle>
                                        <circle cx="350" cy="50" r="8"></circle>
                                        <circle cx="526.335575687742" cy="107.29490168751576" r="8"></circle>
                                        <circle cx="635.316954888546" cy="257.2949016875158" r="8"></circle>
                                        <circle cx="635.316954888546" cy="442.7050983124842" r="8"></circle>
                                        <circle cx="526.335575687742" cy="592.7050983124842" r="8"></circle>
                                        <circle cx="350" cy="650" r="8"></circle>
                                        <circle cx="173.6644243122581" cy="592.7050983124842" r="8"></circle>
                                        <circle cx="64.68304511145396" cy="442.70509831248427" r="8"></circle>
                                        <circle cx="64.68304511145391" cy="257.2949016875158" r="8"></circle>
                                        <circle cx="173.66442431225803" cy="107.29490168751579" r="8"></circle>
                                    </svg>
                                </div>
                ...
                <section id="mental_health" class="contact single_circle" data-smooth-item="data-smooth-item">
                    <div class="contact-content s">
                        <div class="contact-title" style="justify-content: center; display: flex; flex-direction: column; border-bottom: 1px solid; padding-bottom: 140px;">

                            <div class="circle-info">
                                <h3 class="t5 split-title">Mental Health</h3>
                                <!-- <p class="circle-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p> -->
                            </div>
                            ...
                            <div class="col col-7 col-sm-7 col-md-7 col-lg-8 col-xl-6 single_circle__wrapper">
                                ...
                                <video src="video/mentalhealthstone.mp4" class="cover loaded single_circle__video" autoplay playsinline loop="" muted="" style="position: absolute; width: 800px; height: auto;"></video>

                                <div class="single_circle__inner">
                                    <div class="single_circle__txt single_circle__txt--number-1" style="top: 0;">
                                        Spiritual Counseling
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-2" style="top: 30%; right: -50px; text-align: left;">
                                        Somatic Body<br />Therapy
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-3" style="bottom: 60px; top: auto; right: 50px;">
                                        CBT & ACT
                                    </div>
                                    <div class="single_circle__txt single_circle__txt--number-4" style="bottom: 50px; left: 10px; top: auto; right: auto;">Transcendental<br />and mindfulness<br />meditation training</div>
                                    <div class="single_circle__txt single_circle__txt--number-5" style="left: -10px;top: 30%;     right: auto; bottom: auto;">Family<br />Therapy</div>
                ...
                <section class="marquee -padL hide" data-smooth-item="data-smooth-item">
                    <div class="marquee-content">
                        <h2 class="t4 marquee-title">
                            <span class="marquee-container">
                                <span class="marquee-line">World class team, lorem ipsum dolor</span><span class="marquee-line">World class team, lorem ipsum dolor</span>
                            </span>
                        </h2>
                    </div>
                    <p class="marquee-short p1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                </section>
                <section class="team hide" data-smooth-item="data-smooth-item">

                    <h3 class="t5 split-title">Teams</h3>
                    <div class="team-content">
                        <div class="team-list s">
                            <a href="#" class="team-item" data-index="0">
                                <div class="team-asset">
                                    <div class="asset-crop">
                                        <img
                                            class="cover lazy"
                                            src="images/pc.png"
                                            alt="Ken Shubin Stein"
                                        />
                                    </div>
                                </div>
                                <div class="team-info">
                                    <p class="p1">Daniel Manocherian</p>
                                    <p class="team-short-title p">CEO</p>
                                    <p class="team-short-description p">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto </p>
                                </div>
                            </a>
                            <a href="#" class="team-item" data-index="0">
                                <div class="team-asset">
                ...
                <section id="subscribe" class="subscribe" data-smooth-item="data-smooth-item">
                    <div class="subscribe-content s">
                        <form class="subscribe-form" method="POST" name="Subscribe">
                            ...
                            <div class="subscribe-content">
                                ...
                                <div class="form-group"><button class="p1 subscribe-submit">Send Email</button></div>
                            </div>
                            ...
                            <form class="subscribe-form" method="POST" name="Subscribe">
                                ...
                                <div class="subscribe-content">
                                    <div class="form-group">
                                        ...
                                        <input class="newsletter-input p2" id="newsletter_email" name="newsletter_email" type="email" placeholder="Enter your email here" required />
                                    </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                if($(window).width() < 991){
                    ...
                    // $('.single_circle__video').parallaxTilt({
              ...
              // var video = $('.single_circle__video')[0];

              // Play the video on hover
              // $('body').on('mouseover', '.single_circle', function() {
              //   $(this).find('.single_circle__video')[0].play();
              // }, function() {
              //   $(this).find('.single_circle__video')[0].pause();
              // });
            });
