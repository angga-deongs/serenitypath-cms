            ...
            <div class="page is-institute -kelp" data-router-view="page" data-smooth="data-smooth">
                ...
                <section class="hero -fixed" data-smooth-item="data-smooth-item">
                    <div class="hero-content s">
                        ...
                        <h1 class="t2 hero-title -default"><span class="title-line" data-split="lines,words,chars">Find your<br />path</span></h1>
                    </div>
                ...
                <section class="info contact-description" data-smooth-item="data-smooth-item">
                    <div class="info-content">
                        <div class="info-block s">
                            <div class="info-description" style="border: none;">
                                <p class="p5">
                                    Want to learn more about Serenity path? Contact us via form below and we will get back to you soonest.
                                </p>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="contact" class="contact" data-smooth-item="data-smooth-item" style="margin-bottom: 0;">
                    <div class="contact-content s">
                        <form class="contact-form" method="POST" name="General">
                            <input type="hidden" name="action" value="mail" />
                            <input type="hidden" name="type" value="contact" />
                            <input class="form-name" type="hidden" name="form-name" value="General" />
                            <div class="form-group">
                                <label class="p3" for="contact-name">Full Name</label> <input required class="p3" type="text" name="contact-name" id="contact-name" placeholder="Please enter your name" />
                            </div>
                            <div class="form-group">
                                <label class="p3" for="contact-subject">Subject</label>
                                <select class="p3" name="contact-subject" id="contact-subject">
                                    <option>General Inquiry</option>
                                    <option>Press Inquiry</option>
                                </select>
                                <svg class="select-icon"><use xlink:href="#selectArrow"></use></svg>
                            </div>
                            <div class="form-group">
                                <label class="p3" for="contact-email">Mobile no.</label>
                                <input required class="p3" type="text" name="contact-phone" id="contact-email" placeholder="Please enter your mobile number" />
                            </div>
                            <div class="form-group">
                                <label class="p3" for="contact-email">Email</label>
                                <input required class="p3" type="email" name="contact-email" id="contact-email" placeholder="Please enter your email address" />
                            </div>
                            <div class="form-group">
                                <label class="p3" for="contact-message">Message</label> <textarea class="p3" name="contact-message" id="contact-message" placeholder="Please enter a message"></textarea>
                            </div>
                            <div class="form-group">
                                <button class="p1 contact-send">Send Email</button>
                                <p class="p3 contact-success">Thanks! We’ll be in touch shortly</p>
                            </div>
                        </form>
                        <form class="hide" method="POST" name="General">
                            <input type="hidden" name="form-name" value="General" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                                <option value="institute">Atria Institute</option>
                                <option value="academy">Atria Academy of Science & Medicine</option>
                                <option value="health">Atria Health Collaborative</option>
                            </select>
                            <input class="p3" type="email" name="contact-email" /> <textarea class="p3" name="contact-message"></textarea>
                        </form>
                        <form class="hide" method="POST" name="Membership">
                            <input type="hidden" name="form-name" value="Membership" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                        ...
                        <form class="hide" method="POST" name="Press">
                            <input type="hidden" name="form-name" value="Press" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                        ...
                        <form class="hide" method="POST" name="Institute">
                            <input type="hidden" name="form-name" value="Institute" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                        ...
                        <form class="hide" method="POST" name="Academy">
                            <input type="hidden" name="form-name" value="Academy" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                        ...
                        <form class="hide" method="POST" name="Health">
                            <input type="hidden" name="form-name" value="Health" /><input class="p3" type="text" name="contact-name" />
                            <select class="p3" name="contact-subject">
                                <option value="general">General Inquiry</option>
                                <option value="membership">Atria Membership</option>
                                <option value="press">Press Inquiry</option>
                        ...
                        <form class="subscribe-form" method="POST" name="Subscribe">
                            ...
                            <div class="subscribe-content">
                                <div class="form-group">
                                    ...
                                    <input class="newsletter-input" id="newsletter_email" name="newsletter_email" type="email" placeholder="Enter your email here" required />
                                </div>
